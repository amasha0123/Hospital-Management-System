  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cards = <_DashboardCardData>[
      _DashboardCardData(
        ...
        backgroundImage:
            'https://images.unsplash.com/photo-1538108149393-fbbd81895977?auto=format&fit=crop&w=900&q=80',
      ),
      _DashboardCardData(
        title: 'Results Entry',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: NetworkImage(
                      'https://images.unsplash.com/photo-1538108149393-fbbd81895977?auto=format&fit=crop&w=1400&q=80',
                    ),
                    fit: BoxFit.cover,
                  ),
                ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Welcome, ${user?.name ?? 'Lab Staff'}',
                                style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold),
                              ),
                              const SizedBox(height: 8),
                              const Text(
                                'Diagnostics • reporting • quality checks',
